...
// Servo range
#define _DUTY_MIN 1050    //  서보의 최소각도를 microseconds로 표현
#define _DUTY_NEU 1550    //  레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 2050            // 서보의 최대각도의 microseconds의 값

// Servo speed control
#define _SERVO_ANGLE 600   //  최대 가동범위에 따른 목표 서보 회전각
